...
# ---------------------------------------------------------------- большие графы
LARGE_GRAPH = 5_000        # от этого числа узлов включаются приближённые методы (на выданных 2 248 не влияет)
BETWEENNESS_SAMPLE = 100   # betweenness по выборке из 100 стартовых узлов вместо всех (seed=42)
CYCLES_LIMIT = 200_000     # предел перебора возвратных циклов
