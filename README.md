...
Эти страницы собраны той же командой из этого репозитория. AI-ассистент запускается локально (раздел ниже).
...
кэш и маскировку. Всего 83 теста проходят без сети и ключа; ещё 2 теста экрана запускаются, если на машине есть Chrome.
